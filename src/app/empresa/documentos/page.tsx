      ...
      <div className="w-72 bg-[#03091c] border-r border-white/10 flex-shrink-0 flex flex-col">
        ...
        <div className="flex-1 p-4 space-y-1">
          ...
          <div className="mb-6">
            ...
            <Link href="/empresa/documentos" className="w-full flex items-center gap-3 px-3 py-3 rounded-xl bg-blue-600/20 border border-blue-500/30 text-blue-400 font-medium">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-6">
              <div className="flex items-center gap-3">
                ...
                <h1 className="text-white font-medium text-lg">Documentos</h1>
              </div>
            </div>
