...
import {
  ...
  Store, FileText, CalendarHeart, UserCheck, Package, TrendingUp
} from "lucide-react";
  ...
  return (
    ...
    >
      <div className="space-y-6">
        <div>
          <h1 className="text-3xl font-black text-white tracking-tight">Editar Produto</h1>
          <p className="text-blue-300/90 text-sm mt-1">Atualize as informações do produto.</p>
        </div>
          ...
          <div className="xl:col-span-2 space-y-6">
            <div className="bg-white/5 backdrop-blur-2xl border border-white/10 rounded-2xl p-6 shadow-sm">
              ...
              <div className="flex flex-col md:flex-row gap-6 items-center md:items-start mb-6">
                <div className="w-64 h-48 bg-gradient-to-br from-blue-500/30 via-purple-600/30 to-cyan-500/30 rounded-2xl flex items-center justify-center flex-shrink-0">
                  <ShoppingCart className="w-16 h-16 text-white/60" />
                </div>
              </div>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                {[
                  { label: "Nome", value: "Colchão Premium Orthomol" },
                  { label: "Categoria", value: "Colchões" },
                  { label: "Marca", value: "Dr. Sleep" },
                  { label: "Linha", value: "Premium" },
                  { label: "Preço", value: "R$ 4.500" },
                  { label: "Estoque", value: "12" },
                  { label: "Status", value: "Disponível" },
                  { label: "Destaque", value: "Sim" },
                  { label: "Descrição", value: "Colchão ortopédico com molas ensacadas" },
          ...
          <div className="space-y-6">
            <div className="bg-white/5 backdrop-blur-2xl border border-white/10 rounded-2xl p-6 shadow-sm">
              ...
              <div className="space-y-5">
                <div>
                  <p className="text-white/60 text-xs uppercase tracking-wider mb-2">Produto desde</p>
                  <p className="text-white font-semibold">15/03/2026</p>
                </div>
                <div>
                  <p className="text-white/60 text-xs uppercase tracking-wider mb-2">Última venda</p>
                  <p className="text-white font-semibold">18/06/2026</p>
                </div>
                <div>
                  <p className="text-white/60 text-xs uppercase tracking-wider mb-2">Giro</p>
                  <p className="text-emerald-400 font-semibold">Alto</p>
                </div>
                <div className="pt-4 border-t border-white/10">
                  <p className="text-white/60 text-xs uppercase tracking-wider mb-2">Estoque atual</p>
                  <p className="text-white font-semibold">12 unidades</p>
                </div>
              </div>
            </div>
