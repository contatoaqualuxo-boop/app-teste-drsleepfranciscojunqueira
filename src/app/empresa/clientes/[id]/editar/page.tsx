  ...
  return (
    ...
    >
      <div className="space-y-6">
        <div>
          <h1 className="text-3xl font-black text-white tracking-tight">Editar Cliente</h1>
          <p className="text-blue-300/90 text-sm mt-1">Atualize as informações do cliente.</p>
        </div>
          ...
          <div className="xl:col-span-2 space-y-6">
            <div className="bg-white/5 backdrop-blur-2xl border border-white/10 rounded-2xl p-6 shadow-sm">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                {[
                  { label: "Nome", value: "Ana Carolina Silva" },
                  { label: "CPF", value: "123.456.789-00" },
                  { label: "Telefone", value: "(11) 98765-4321" },
                  { label: "WhatsApp", value: "(11) 98765-4321" },
                  { label: "Email", value: "ana@exemplo.com" },
                  { label: "Cidade", value: "São Paulo, SP" },
                  { label: "Produto de interesse", value: "Colchões Premium" },
                  { label: "Status", value: "Ativo" },
                  { label: "Score de relacionamento", value: "85" },
                  { label: "Observações", value: "Cliente prefere colchões de molas ensacadas" }
                ].map((item, i) => (
          ...
          <div className="space-y-6">
            <div className="bg-white/5 backdrop-blur-2xl border border-white/10 rounded-2xl p-6 shadow-sm">
              ...
              <div className="space-y-5">
                ...
                <div>
                  <p className="text-white/60 text-xs uppercase tracking-wider mb-2">Última compra</p>
                ...
                <div className="pt-4 border-t border-white/10">
                  <p className="text-white/60 text-xs uppercase tracking-wider mb-2">Programa fidelidade</p>
